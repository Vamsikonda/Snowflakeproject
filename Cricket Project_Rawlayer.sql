-- Raw layer : we need to try to convert unformatted data into strutured data--
...
--- I have total 33 files need uplaod all the data in to the data from stage 
...
select count(*) from cricket.raw.match_raw_tbl;  ---- 33 matchig with source

-- lets run top 10 records.
select * from cricket.raw.match_raw_tbl limit 10; ----- onky top 10 records
