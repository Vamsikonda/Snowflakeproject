...
list @csv_stg
------ csv_stg/initial/menu/menu-initial-load.csv
----- csv_stg/delta/menu/day-01-menu-data.csv
----- csv_stg/delta/menu/day-02-menu-data.csv

Select *from stage_sch.menu limit 10;
...
COMMENT = 'This table stores the dimension data for the menu items, tracking historical changes using SCD Type 2. 
Each menu item has an effective start and end date, with a flag indicating if it is the current record or historical. 
The hash key (Menu_Dim_HK) is generated based on Menu_ID and Restaurant_ID.';
