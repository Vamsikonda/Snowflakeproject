...
comment = 'This is the delivery stage/raw table where data will be copied from internal stage using copy command. 
This is as-is data represetation from the source location. All the columns are text data type except the audit columns that are added for traceability.';
...
-----csv_stg/delta/delivery-agent/day-01-delivery-agent.csv
-----csv_stg/delta/delivery-agent/day-02-delivery-agent.csv
